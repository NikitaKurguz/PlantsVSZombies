...
Pea::Pea(sf::Vector2f position, GameField* field, float damage,
    float speed, int shooterID): 
    Projectile(position, "textures\\plants\\pea2.png",
        { 0, 0, 1152, 720 }, { 80, 45 }, field, damage, speed, 800),
    shooterID(shooterID)
{
}
